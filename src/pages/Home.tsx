...
import { getProducts } from "../services/api/datas";
    ...
    <div className="space-y-16 sm:space-y-[72px] mb-16 sm:mb-[72px]">
      ...
      >
        <div className="w-full text-white flex flex-col items-center justify-center text-center">
          ...
          <div className="flex justify-center items-center mt-11">
            ...
            <Button variant="secondary" className="!size-11 !px-0">
              <img src={arrow} alt="arrow icon" className="size-5" />
            </Button>
          </div>
        </div>
      </section>
      <p className="text-center text-xl sm:text-2xl lg:text-3xl font-bold text-chillax">
      ...
      <section>
        <div className="space-y-8">
          ...
          <Button
            variant="secondary"
            className="mx-auto outline outline-1 outline-black"
          >
            View more
          </Button>
        </div>
      ...
      <section className="space-y-8">
        <div className="space-1 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-chillax">
            OUR COLLECTION
          </h2>
          <p className="text-gray-dark text-sm sm:text-base lg:text-lg">
        ...
        <div className="flex max-md:flex-col gap-4">
          <div
            className="relative h-[446px] w-full md:w-xl rounded-4xl bg-cover overflow-hidden"
            style={{
          ...
          <div
            className="relative h-[446px] rounded-4xl bg-no-repeat bg-cover bg-[center_45%] overflow-hidden grow"
            style={{
          ...
          >
            <div className="p-6 flex flex-col gap-1 items-center text-center justify-center absolute inset-0 bg-black/50 text-white">
              <h3 className="uppercase font-bold text-3xl lg:text-5xl font-chillax text-stroke text-transparent">
                Classic men
              </h3>
